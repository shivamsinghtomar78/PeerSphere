# Phase 7: Resume and JD Processing — Information Extraction

## Objective

Document the implementation contract for **Information Extraction** within Phase 7. Defines schema-constrained extraction for skills, education, dates, projects, experience, certifications, and requirements. Each field carries source spans, parser/model version, and confidence.

## Deliverables

- An approved, version-controlled specification for Information Extraction.
...
Phases 3–6 provide secured storage, data models, job/resume ingestion points, and audit events.

## Implementation Requirements

Defines schema-constrained extraction for skills, education, dates, projects, experience, certifications, and requirements. Each field carries source spans, parser/model version, and confidence.
...
### Task 7.1: Define and implement Information Extraction
...
- Planned API: `apps/api/src/modules/information-extraction/`
- Planned web client: `apps/web/src/features/information-extraction/`
- Planned tests: `apps/api/test/information-extraction/` and `apps/web/src/features/information-extraction/__tests__/`
...
A developer can implement and verify Information Extraction using only this document and its linked architecture, security, data, and test contracts.
...
### Task 7.2: Review evidence and release gate
...
- `docs/07-resume-and-jd-processing/phase-completion.md`
- Test reports and CI artifacts for the implementing services.

#### Dependencies

Task 7.1 has implementation and test evidence.
