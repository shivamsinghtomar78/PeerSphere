# Phase 7: Resume and JD Processing — Taxonomy

## Objective

Document the implementation contract for **Taxonomy** within Phase 7. Defines a governed, versioned taxonomy: canonical skill, aliases, category, related skills, deprecated terms, proficiency evidence expectations, and reviewer workflow.

## Deliverables

- An approved, version-controlled specification for Taxonomy.
...
Defines a governed, versioned taxonomy: canonical skill, aliases, category, related skills, deprecated terms, proficiency evidence expectations, and reviewer workflow.
...
### Task 7.1: Define and implement Taxonomy
...
- Planned API: `apps/api/src/modules/taxonomy/`
- Planned web client: `apps/web/src/features/taxonomy/`
- Planned tests: `apps/api/test/taxonomy/` and `apps/web/src/features/taxonomy/__tests__/`
...
A developer can implement and verify Taxonomy using only this document and its linked architecture, security, data, and test contracts.
