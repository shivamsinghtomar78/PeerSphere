# Phase 7: Resume and JD Processing — JD Processing

## Objective

Document the implementation contract for **JD Processing** within Phase 7. Defines JD ingestion, text extraction, chunking, requirement extraction, hard/soft classification, normalization, validation UI, versioning, and fallback to manual entry.

## Deliverables

- An approved, version-controlled specification for JD Processing.
...
Defines JD ingestion, text extraction, chunking, requirement extraction, hard/soft classification, normalization, validation UI, versioning, and fallback to manual entry.
...
### Task 7.1: Define and implement JD Processing
...
- Planned API: `apps/api/src/modules/jd-processing/`
- Planned web client: `apps/web/src/features/jd-processing/`
- Planned tests: `apps/api/test/jd-processing/` and `apps/web/src/features/jd-processing/__tests__/`
...
A developer can implement and verify JD Processing using only this document and its linked architecture, security, data, and test contracts.
