# Phase 7: Resume and JD Processing — Skill Normalization

## Objective

Document the implementation contract for **Skill Normalization** within Phase 7. Defines canonical skill matching through case folding, aliases, technology-family relations, explicit ambiguity handling, provenance, and a rule that raw text is never discarded.

## Deliverables

- An approved, version-controlled specification for Skill Normalization.
...
Defines canonical skill matching through case folding, aliases, technology-family relations, explicit ambiguity handling, provenance, and a rule that raw text is never discarded.
...
### Task 7.1: Define and implement Skill Normalization
...
- Planned API: `apps/api/src/modules/skill-normalization/`
- Planned web client: `apps/web/src/features/skill-normalization/`
- Planned tests: `apps/api/test/skill-normalization/` and `apps/web/src/features/skill-normalization/__tests__/`
...
A developer can implement and verify Skill Normalization using only this document and its linked architecture, security, data, and test contracts.
