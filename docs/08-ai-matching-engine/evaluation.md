# Phase 8: AI Matching Engine — Evaluation

## Objective

Document the implementation contract for **Evaluation** within Phase 8. Defines expert-labelled offline evaluation, precision/recall/F1, extraction accuracy, ranking quality, false-positive/negative review, calibration checks, fairness slices, and release thresholds.

## Deliverables

- An approved, version-controlled specification for Evaluation.
...
Defines expert-labelled offline evaluation, precision/recall/F1, extraction accuracy, ranking quality, false-positive/negative review, calibration checks, fairness slices, and release thresholds.
...
### Task 8.1: Define and implement Evaluation
...
- Planned API: `apps/api/src/modules/evaluation/`
- Planned web client: `apps/web/src/features/evaluation/`
- Planned tests: `apps/api/test/evaluation/` and `apps/web/src/features/evaluation/__tests__/`
...
A developer can implement and verify Evaluation using only this document and its linked architecture, security, data, and test contracts.
