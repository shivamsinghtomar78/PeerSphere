# Phase 8: AI Matching Engine — Semantic Matching

## Objective

Document the implementation contract for **Semantic Matching** within Phase 8. Defines skill and evidence matching using taxonomy relationships, embeddings, calibrated thresholds, and lexical checks. Semantic similarity cannot override hard eligibility.

## Deliverables

- An approved, version-controlled specification for Semantic Matching.
...
Defines skill and evidence matching using taxonomy relationships, embeddings, calibrated thresholds, and lexical checks. Semantic similarity cannot override hard eligibility.
...
### Task 8.1: Define and implement Semantic Matching
...
- Planned API: `apps/api/src/modules/semantic-matching/`
- Planned web client: `apps/web/src/features/semantic-matching/`
- Planned tests: `apps/api/test/semantic-matching/` and `apps/web/src/features/semantic-matching/__tests__/`
...
A developer can implement and verify Semantic Matching using only this document and its linked architecture, security, data, and test contracts.
