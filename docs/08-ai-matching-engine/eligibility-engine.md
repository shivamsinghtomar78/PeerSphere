# Phase 8: AI Matching Engine — Eligibility Engine

## Objective

Document the implementation contract for **Eligibility Engine** within Phase 8. Defines deterministic evaluation of CGPA, branch, graduation year, backlogs, and other explicit rules. Unknown/missing data returns an explainable indeterminate result, never an assumed pass.

## Deliverables

- An approved, version-controlled specification for Eligibility Engine.
...
Defines deterministic evaluation of CGPA, branch, graduation year, backlogs, and other explicit rules. Unknown/missing data returns an explainable indeterminate result, never an assumed pass.
...
### Task 8.1: Define and implement Eligibility Engine
...
- Planned API: `apps/api/src/modules/eligibility-engine/`
- Planned web client: `apps/web/src/features/eligibility-engine/`
- Planned tests: `apps/api/test/eligibility-engine/` and `apps/web/src/features/eligibility-engine/__tests__/`
...
A developer can implement and verify Eligibility Engine using only this document and its linked architecture, security, data, and test contracts.
