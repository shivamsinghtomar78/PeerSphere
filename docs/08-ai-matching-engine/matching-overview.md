# Phase 8: AI Matching Engine — Matching Overview

## Objective

Document the implementation contract for **Matching Overview** within Phase 8. Defines the hybrid pipeline: validated job requirements → deterministic eligibility → evidence retrieval → semantic and lexical soft matching → weighted score → confidence → explanation → review decision.

## Deliverables

- An approved, version-controlled specification for Matching Overview.
...
Defines the hybrid pipeline: validated job requirements → deterministic eligibility → evidence retrieval → semantic and lexical soft matching → weighted score → confidence → explanation → review decision.
...
### Task 8.1: Define and implement Matching Overview
...
- Planned API: `apps/api/src/modules/matching-overview/`
- Planned web client: `apps/web/src/features/matching-overview/`
- Planned tests: `apps/api/test/matching-overview/` and `apps/web/src/features/matching-overview/__tests__/`
...
A developer can implement and verify Matching Overview using only this document and its linked architecture, security, data, and test contracts.
