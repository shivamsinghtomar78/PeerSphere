# Phase 16: Project Completion — Defense Demo

## Objective

Document the implementation contract for **Defense Demo** within Phase 16. Defines an examination/demo script with architecture, safety boundaries, live workflow, deterministic and AI components, tests/metrics, limitations, override audit, and deployment controls.

## Deliverables

- An approved, version-controlled specification for Defense Demo.
...
Defines an examination/demo script with architecture, safety boundaries, live workflow, deterministic and AI components, tests/metrics, limitations, override audit, and deployment controls.
...
### Task 16.1: Define and implement Defense Demo
...
- Planned API: `apps/api/src/modules/defense-demo/`
- Planned web client: `apps/web/src/features/defense-demo/`
- Planned tests: `apps/api/test/defense-demo/` and `apps/web/src/features/defense-demo/__tests__/`
...
A developer can implement and verify Defense Demo using only this document and its linked architecture, security, data, and test contracts.
