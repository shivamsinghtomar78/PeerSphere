# Phase 10: Placement Workflow — Shortlist Flow

## Objective

Document the implementation contract for **Shortlist Flow** within Phase 10. Defines shortlist eligibility, reviewer confirmation, notification, reason capture, reversal rules, and communication templates that avoid presenting an AI recommendation as a final decision.

## Deliverables

- An approved, version-controlled specification for Shortlist Flow.
...
Defines shortlist eligibility, reviewer confirmation, notification, reason capture, reversal rules, and communication templates that avoid presenting an AI recommendation as a final decision.
...
### Task 10.1: Define and implement Shortlist Flow
...
- Planned API: `apps/api/src/modules/shortlist-flow/`
- Planned web client: `apps/web/src/features/shortlist-flow/`
- Planned tests: `apps/api/test/shortlist-flow/` and `apps/web/src/features/shortlist-flow/__tests__/`
...
A developer can implement and verify Shortlist Flow using only this document and its linked architecture, security, data, and test contracts.
