# Phase 10: Placement Workflow — Screening Flow

## Objective

Document the implementation contract for **Screening Flow** within Phase 10. Defines screening queue order, evaluation lifecycle, manual-review triggers, reviewer assignments, conflicts handling, and audit requirements before a disposition changes.

## Deliverables

- An approved, version-controlled specification for Screening Flow.
...
Defines screening queue order, evaluation lifecycle, manual-review triggers, reviewer assignments, conflicts handling, and audit requirements before a disposition changes.
...
### Task 10.1: Define and implement Screening Flow
...
- Planned API: `apps/api/src/modules/screening-flow/`
- Planned web client: `apps/web/src/features/screening-flow/`
- Planned tests: `apps/api/test/screening-flow/` and `apps/web/src/features/screening-flow/__tests__/`
...
A developer can implement and verify Screening Flow using only this document and its linked architecture, security, data, and test contracts.
