# Phase 10: Placement Workflow — Rejection Analysis

## Objective

Document the implementation contract for **Rejection Analysis** within Phase 10. Defines student-safe explanations for lower alignment, absent/partial evidence, unknown criteria, appeal/correction pathway, and prohibited language such as definitive aptitude claims.

## Deliverables

- An approved, version-controlled specification for Rejection Analysis.
...
Phases 5, 6, 8, and 9 provide student/admin interfaces, evaluations, and feedback.

## Implementation Requirements

Defines student-safe explanations for lower alignment, absent/partial evidence, unknown criteria, appeal/correction pathway, and prohibited language such as definitive aptitude claims.
...
### Task 10.1: Define and implement Rejection Analysis
...
- Planned API: `apps/api/src/modules/rejection-analysis/`
- Planned web client: `apps/web/src/features/rejection-analysis/`
- Planned tests: `apps/api/test/rejection-analysis/` and `apps/web/src/features/rejection-analysis/__tests__/`
...
A developer can implement and verify Rejection Analysis using only this document and its linked architecture, security, data, and test contracts.
...
### Task 10.2: Review evidence and release gate
...
- `docs/10-placement-workflow/phase-completion.md`
- Test reports and CI artifacts for the implementing services.

#### Dependencies

Task 10.1 has implementation and test evidence.
