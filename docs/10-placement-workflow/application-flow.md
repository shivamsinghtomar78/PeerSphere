# Phase 10: Placement Workflow — Application Flow

## Objective

Document the implementation contract for **Application Flow** within Phase 10. Defines application states, deadlines, eligibility feedback, consent, submission idempotency, withdrawal policy, notifications, and immutable snapshots at submit time.

## Deliverables

- An approved, version-controlled specification for Application Flow.
...
Defines application states, deadlines, eligibility feedback, consent, submission idempotency, withdrawal policy, notifications, and immutable snapshots at submit time.
...
### Task 10.1: Define and implement Application Flow
...
- Planned API: `apps/api/src/modules/application-flow/`
- Planned web client: `apps/web/src/features/application-flow/`
- Planned tests: `apps/api/test/application-flow/` and `apps/web/src/features/application-flow/__tests__/`
...
A developer can implement and verify Application Flow using only this document and its linked architecture, security, data, and test contracts.
