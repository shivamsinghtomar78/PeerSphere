...
Document the implementation contract for **Validation** within Phase 3. Defines database constraints and migration checks: enums, foreign keys, non-negative scores, valid dates, allowed state transitions, JSON schema validation at application boundaries, and soft-delete conventions.

## Deliverables

- An approved, version-controlled specification for Validation.
...
Defines database constraints and migration checks: enums, foreign keys, non-negative scores, valid dates, allowed state transitions, JSON schema validation at application boundaries, and soft-delete conventions.
...
### Task 3.1: Define and implement Validation
...
- Planned API: `apps/api/src/modules/validation/`
- Planned web client: `apps/web/src/features/validation/`
- Planned tests: `apps/api/test/validation/` and `apps/web/src/features/validation/__tests__/`
...
A developer can implement and verify Validation using only this document and its linked architecture, security, data, and test contracts.
