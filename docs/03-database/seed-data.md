...
Document the implementation contract for **Seed Data** within Phase 3. Defines anonymized, non-production seed fixtures for eligible/ineligible students, diverse skills, malformed documents, varied JDs, and human-labelled matching expectations.

## Deliverables

- An approved, version-controlled specification for Seed Data.
...
Defines anonymized, non-production seed fixtures for eligible/ineligible students, diverse skills, malformed documents, varied JDs, and human-labelled matching expectations.
...
### Task 3.1: Define and implement Seed Data
...
- Planned API: `apps/api/src/modules/seed-data/`
- Planned web client: `apps/web/src/features/seed-data/`
- Planned tests: `apps/api/test/seed-data/` and `apps/web/src/features/seed-data/__tests__/`
...
A developer can implement and verify Seed Data using only this document and its linked architecture, security, data, and test contracts.
