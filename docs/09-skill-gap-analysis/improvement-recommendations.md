# Phase 9: Skill Gap Analysis — Improvement Recommendations

## Objective

Document the implementation contract for **Improvement Recommendations** within Phase 9. Defines prioritized, actionable recommendations tied to gaps: a practice activity, a demonstrable artifact, and a verification path. Wording says alignment may improve, never promises selection.

## Deliverables

- An approved, version-controlled specification for Improvement Recommendations.
...
Phase 8 supplies versioned eligibility, match, confidence, and evidence outputs.

## Implementation Requirements

Defines prioritized, actionable recommendations tied to gaps: a practice activity, a demonstrable artifact, and a verification path. Wording says alignment may improve, never promises selection.
...
### Task 9.1: Define and implement Improvement Recommendations
...
- Planned API: `apps/api/src/modules/improvement-recommendations/`
- Planned web client: `apps/web/src/features/improvement-recommendations/`
- Planned tests: `apps/api/test/improvement-recommendations/` and `apps/web/src/features/improvement-recommendations/__tests__/`
...
A developer can implement and verify Improvement Recommendations using only this document and its linked architecture, security, data, and test contracts.
...
### Task 9.2: Review evidence and release gate
...
- `docs/09-skill-gap-analysis/phase-completion.md`
- Test reports and CI artifacts for the implementing services.

#### Dependencies

Task 9.1 has implementation and test evidence.
...
Each recommendation must reference a specific requirement or recurring role-family gap and contain:

1. the skill or evidence gap;
2. why it matters for the relevant type of role;
3. a bounded activity;
4. a demonstrable artifact; and
5. a way to update the profile/resume after completion.

Example: “For the missing Spring Boot requirement, build a REST API with MySQL, authentication, CRUD endpoints, and API documentation. Add the repository and a short description of your contribution to your profile. This can increase alignment with similar job requirements; it does not guarantee selection.”

Recommendations must be prioritized by requiredness, frequency, evidence quality, and student-selected goals. Never infer protected characteristics, prescribe paid training, promise outcomes, or present an unexplained recommendation.
