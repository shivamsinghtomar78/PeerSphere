# Phase 9: Skill Gap Analysis — Weak Skills

## Objective

Document the implementation contract for **Weak Skills** within Phase 9. Defines partial matches based on thresholded evidence quality, recency, project/experience context, and requirement level; never infer mastery from a single keyword.

## Deliverables

- An approved, version-controlled specification for Weak Skills.
...
Defines partial matches based on thresholded evidence quality, recency, project/experience context, and requirement level; never infer mastery from a single keyword.
...
### Task 9.1: Define and implement Weak Skills
...
- Planned API: `apps/api/src/modules/weak-skills/`
- Planned web client: `apps/web/src/features/weak-skills/`
- Planned tests: `apps/api/test/weak-skills/` and `apps/web/src/features/weak-skills/__tests__/`
...
A developer can implement and verify Weak Skills using only this document and its linked architecture, security, data, and test contracts.
