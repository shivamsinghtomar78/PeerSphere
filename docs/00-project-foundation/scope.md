# Phase 0: Project Foundation — Scope

## Objective

Document the implementation contract for **Scope** within Phase 0. Defines MVP inclusions and exclusions. The MVP supports campus opportunities, two primary roles, controlled uploads, explainable recommendations, and manual override; it excludes automated rejection and external hiring integrations.

## Deliverables

- An approved, version-controlled specification for Scope.
...
Defines MVP inclusions and exclusions. The MVP supports campus opportunities, two primary roles, controlled uploads, explainable recommendations, and manual override; it excludes automated rejection and external hiring integrations.
...
### Task 0.1: Define and implement Scope
...
- Planned API: `apps/api/src/modules/scope/`
- Planned web client: `apps/web/src/features/scope/`
- Planned tests: `apps/api/test/scope/` and `apps/web/src/features/scope/__tests__/`
...
A developer can implement and verify Scope using only this document and its linked architecture, security, data, and test contracts.
