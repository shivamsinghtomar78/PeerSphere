# Phase 4: Authentication and Authorization — Roles

## Objective

Document the implementation contract for **Roles** within Phase 4. Defines STUDENT and PLACEMENT_ADMIN. STUDENTs can manage only their own profile/resumes/applications; PLACEMENT_ADMINs manage opportunities and authorized candidate review. No extra role is added without a documented use case.

## Deliverables

- An approved, version-controlled specification for Roles.
...
Phase 3 identity-related schema and security architecture are approved.

## Implementation Requirements

Defines STUDENT and PLACEMENT_ADMIN. STUDENTs can manage only their own profile/resumes/applications; PLACEMENT_ADMINs manage opportunities and authorized candidate review. No extra role is added without a documented use case.
...
### Task 4.1: Define and implement Roles
...
- Planned API: `apps/api/src/modules/roles/`
- Planned web client: `apps/web/src/features/roles/`
- Planned tests: `apps/api/test/roles/` and `apps/web/src/features/roles/__tests__/`
...
A developer can implement and verify Roles using only this document and its linked architecture, security, data, and test contracts.
...
### Task 4.2: Review evidence and release gate
...
- `docs/04-authentication-and-authorization/phase-completion.md`
- Test reports and CI artifacts for the implementing services.

#### Dependencies

Task 4.1 has implementation and test evidence.
