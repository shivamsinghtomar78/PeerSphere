...
Document the implementation contract for **Data Flow** within Phase 2. Describes events from upload through malware scan, text extraction, normalized evidence, job processing, deterministic eligibility, scoring, review, and audit trail.

## Deliverables

- An approved, version-controlled specification for Data Flow.
...
Describes events from upload through malware scan, text extraction, normalized evidence, job processing, deterministic eligibility, scoring, review, and audit trail.
...
### Task 2.1: Define and implement Data Flow
...
- Planned API: `apps/api/src/modules/data-flow/`
- Planned web client: `apps/web/src/features/data-flow/`
- Planned tests: `apps/api/test/data-flow/` and `apps/web/src/features/data-flow/__tests__/`
...
A developer can implement and verify Data Flow using only this document and its linked architecture, security, data, and test contracts.
