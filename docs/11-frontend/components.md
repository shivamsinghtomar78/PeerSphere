...
Document the implementation contract for **Components** within Phase 11. Defines reusable components and contracts including file uploader, evidence panel, eligibility badge, match breakdown, confidence indicator, review banner, filters, data table, and confirmation dialog.

## Deliverables

- An approved, version-controlled specification for Components.
...
Defines reusable components and contracts including file uploader, evidence panel, eligibility badge, match breakdown, confidence indicator, review banner, filters, data table, and confirmation dialog.
...
### Task 11.1: Define and implement Components
...
- Planned API: `apps/api/src/modules/components/`
- Planned web client: `apps/web/src/features/components/`
- Planned tests: `apps/api/test/components/` and `apps/web/src/features/components/__tests__/`
...
A developer can implement and verify Components using only this document and its linked architecture, security, data, and test contracts.
