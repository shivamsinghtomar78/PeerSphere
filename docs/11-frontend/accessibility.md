# Phase 11: Frontend — Accessibility

## Objective

Document the implementation contract for **Accessibility** within Phase 11. Defines WCAG 2.2 AA targets: keyboard paths, semantic HTML, focus management, contrast, labels, readable status messages, accessible tables/charts, mobile reflow, and automated/manual audits.

## Deliverables

- An approved, version-controlled specification for Accessibility.
...
Defines WCAG 2.2 AA targets: keyboard paths, semantic HTML, focus management, contrast, labels, readable status messages, accessible tables/charts, mobile reflow, and automated/manual audits.
...
### Task 11.1: Define and implement Accessibility
...
- Planned API: `apps/api/src/modules/accessibility/`
- Planned web client: `apps/web/src/features/accessibility/`
- Planned tests: `apps/api/test/accessibility/` and `apps/web/src/features/accessibility/__tests__/`
...
A developer can implement and verify Accessibility using only this document and its linked architecture, security, data, and test contracts.
...
+## Next.js Accessibility Checks

Use semantic Next.js page/layout structure, meaningful route titles, route-change focus management, accessible client-side navigation, and test the rendered app—not only isolated components. Verify all interactive TypeScript components at supported breakpoints using keyboard navigation, screen-reader output, reduced motion, and reduced transparency settings.
