...
Document the implementation contract for **Pages** within Phase 11. Defines student and administrator page inventory, routing guards, loading/empty/error states, permission-denied behavior, responsive layouts, and content that differentiates recommendation from decision.

## Deliverables

- An approved, version-controlled specification for Pages.
...
Defines student and administrator page inventory, routing guards, loading/empty/error states, permission-denied behavior, responsive layouts, and content that differentiates recommendation from decision.
...
### Task 11.1: Define and implement Pages
...
- Planned API: `apps/api/src/modules/pages/`
- Planned web client: `apps/web/src/features/pages/`
- Planned tests: `apps/api/test/pages/` and `apps/web/src/features/pages/__tests__/`
...
A developer can implement and verify Pages using only this document and its linked architecture, security, data, and test contracts.
