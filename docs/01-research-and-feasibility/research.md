# Phase 1: Research and Feasibility — Research

## Objective

Document the implementation contract for **Research** within Phase 1. Records the evidence to gather from placement staff and students: sample JDs, anonymized resumes, eligibility policies, workflow volumes, and fairness concerns.

## Deliverables

- An approved, version-controlled specification for Research.
...
Records the evidence to gather from placement staff and students: sample JDs, anonymized resumes, eligibility policies, workflow volumes, and fairness concerns.
...
### Task 1.1: Define and implement Research
...
- Planned API: `apps/api/src/modules/research/`
- Planned web client: `apps/web/src/features/research/`
- Planned tests: `apps/api/test/research/` and `apps/web/src/features/research/__tests__/`
...
A developer can implement and verify Research using only this document and its linked architecture, security, data, and test contracts.
...
+## Research Knowledge Base Protocol

Capture each approved external or internal research source in [the vault raw folder](../../Shivam%20singh/raw/), then ingest it under the rules in [the vault schema](../../Shivam%20singh/AGENTS.md). Link source-backed findings from this document to the compiled wiki. Run a wiki lint before closing this research phase to surface unlinked sources, contradiction, and open questions.
