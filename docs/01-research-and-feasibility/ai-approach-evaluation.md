# Phase 1: Research and Feasibility — AI Approach Evaluation

## Objective

Document the implementation contract for **AI Approach Evaluation** within Phase 1. Evaluates hybrid extraction and matching: rules for hard criteria; taxonomy plus embeddings for soft criteria; constrained LLMs only for extraction/explanation; human-labelled data for measurement.

## Deliverables

- An approved, version-controlled specification for AI Approach Evaluation.
...
Evaluates hybrid extraction and matching: rules for hard criteria; taxonomy plus embeddings for soft criteria; constrained LLMs only for extraction/explanation; human-labelled data for measurement.
...
### Task 1.1: Define and implement AI Approach Evaluation
...
- Planned API: `apps/api/src/modules/ai-approach-evaluation/`
- Planned web client: `apps/web/src/features/ai-approach-evaluation/`
- Planned tests: `apps/api/test/ai-approach-evaluation/` and `apps/web/src/features/ai-approach-evaluation/__tests__/`
...
A developer can implement and verify AI Approach Evaluation using only this document and its linked architecture, security, data, and test contracts.
