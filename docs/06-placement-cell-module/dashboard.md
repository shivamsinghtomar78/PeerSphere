# Phase 6: Placement Cell Module — Dashboard

## Objective

Document the implementation contract for **Dashboard** within Phase 6. Defines job and candidate operational dashboards with counts by processing state, eligibility, confidence, manual-review queue, deadlines, and audit-visible actions.

## Deliverables

- An approved, version-controlled specification for Dashboard.
...
Defines job and candidate operational dashboards with counts by processing state, eligibility, confidence, manual-review queue, deadlines, and audit-visible actions.
...
### Task 6.1: Define and implement Dashboard
...
- Planned API: `apps/api/src/modules/dashboard/`
- Planned web client: `apps/web/src/features/dashboard/`
- Planned tests: `apps/api/test/dashboard/` and `apps/web/src/features/dashboard/__tests__/`
...
A developer can implement and verify Dashboard using only this document and its linked architecture, security, data, and test contracts.
