# Phase 6: Placement Cell Module — Job Management

## Objective

Document the implementation contract for **Job Management** within Phase 6. Defines job draft, validation, publish, close, archive, JD upload, parsed requirement correction, versioning, and immutable evaluation-input policy.

## Deliverables

- An approved, version-controlled specification for Job Management.
...
Defines job draft, validation, publish, close, archive, JD upload, parsed requirement correction, versioning, and immutable evaluation-input policy.
...
### Task 6.1: Define and implement Job Management
...
- Planned API: `apps/api/src/modules/job-management/`
- Planned web client: `apps/web/src/features/job-management/`
- Planned tests: `apps/api/test/job-management/` and `apps/web/src/features/job-management/__tests__/`
...
A developer can implement and verify Job Management using only this document and its linked architecture, security, data, and test contracts.
