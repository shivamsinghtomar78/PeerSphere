# Phase 6: Placement Cell Module — Candidate Management

## Objective

Document the implementation contract for **Candidate Management** within Phase 6. Defines candidate lists, evidence drill-down, comparison view, review decision capture, batch actions with safeguards, export limits, and required reason for manual override.

## Deliverables

- An approved, version-controlled specification for Candidate Management.
...
Phases 2–4 provide API, data model, and administrator authorization.

## Implementation Requirements

Defines candidate lists, evidence drill-down, comparison view, review decision capture, batch actions with safeguards, export limits, and required reason for manual override.
...
### Task 6.1: Define and implement Candidate Management
...
- Planned API: `apps/api/src/modules/candidate-management/`
- Planned web client: `apps/web/src/features/candidate-management/`
- Planned tests: `apps/api/test/candidate-management/` and `apps/web/src/features/candidate-management/__tests__/`
...
A developer can implement and verify Candidate Management using only this document and its linked architecture, security, data, and test contracts.
...
### Task 6.2: Review evidence and release gate
...
- `docs/06-placement-cell-module/phase-completion.md`
- Test reports and CI artifacts for the implementing services.

#### Dependencies

Task 6.1 has implementation and test evidence.
