    ...
    data: {
      ...
      versions: {
        create: {
          ...
          workMode: data.workMode as Prisma.JobVersionCreateInput['workMode'],
          jobType: data.jobType as Prisma.JobVersionCreateInput['jobType'],
          salary: data.salary,
...
export async function updateJob(jobId: string, data: Partial<CreateJobDto>) {
  ...
  const newVersion = await prisma.jobVersion.create({
    data: {
      ...
      workMode: (data.workMode as Prisma.JobVersionCreateInput['workMode']) ?? prev.workMode,
      jobType: (data.jobType as Prisma.JobVersionCreateInput['jobType']) ?? prev.jobType,
